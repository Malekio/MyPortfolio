          ...
          <div className={styles.intro}>
            ...
            <div>
              <h1
                ...
                data-scroll-direction="horizontal"
              >
                <span className={`text-6xl tracking-tighter text-foreground 2xl:text-8xl ${archivoBlack.className}`}>
                  HI I’M MALEK
                  <br />
                </span>
              </h1>
              <p
                ...
                data-scroll-enable-touch-speed
                data-scroll-speed=".06"
                className={`mt-1 max-w-lg tracking-tight text-muted-foreground 2xl:text-xl ${archivoBlack.className}`}
              >
                An experienced backend developer with a passion for
        ...
        <section id="about" data-scroll-section>
          ...
          >
            {/* <h2 className="py-16  pb-2 text-3xl font-light leading-normal tracking-tighter text-foreground xl:text-[40px]">
              I&apos;m an experienced backend developer proficient in{" "}
              <Link
              ...
              relational databases, since 2021. I gained experience from building to mid-sized
